-- ============================
-- Handle SCD Type 1 and Type 2 updates in mart.sales_report
-- ============================

-- SCD Type 1: Update current rows if attribute values changed (except versioning and flags)
...
-- SCD Type 2: Insert new versions for records with _ver2 suffix and expire old ones
...
-- Insert new SCD2 version records
